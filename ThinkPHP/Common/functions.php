...
function L($name=null, $value=null) {
    ...
    if (is_string($name)) {
        ...
        if (is_null($value)){
            ...
            if(isset($name[2])) {
                return isset($_lang[$name[0]][$name[1]][$name[2]]) ? $_lang[$name[0]][$name[1]][$name[2]] : $name;
            } elseif(isset($name[1])) {
                return isset($_lang[$name[0]][$name[1]]) ? $_lang[$name[0]][$name[1]] : $name;
            } elseif(isset($name[0])) {
                return isset($_lang[$name[0]]) ? $_lang[$name[0]] : $name;
            }
...
function D($name='',$layer='') {
    ...
    /**
     * fix model name lowercase err in linux
     * @add wangxi
     */
    $name=ucfirst($name);
