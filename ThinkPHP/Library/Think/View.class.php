...
class View {
    ...
    public function display($templateFile='',$charset='',$contentType='',$content='',$prefix='') {
        ...
        /**
         * @fix template not found on linux
         * @wang
         */
        try{
            // 解析并获取模板内容
            ...
            $back_traces=debug_backtrace();
            $proxy_display_call=$back_traces[2]['function'];
            $content=$this->fetch($proxy_display_call, $content, $prefix);
        }
