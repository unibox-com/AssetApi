...
class CabinetController extends BaseController {
    ...
    public function getCabinetList(){
        ...
        if (!empty($this->_memberId)) {
            $cabinetId = D('MemberOrganization')->getFieldByMemberId($this->_memberId, 'cabinet_id');
        } else {
            $cabinetId = 0;
        }
    ...
    public function setCabinet(){
        ...
        if (!empty($cabinetId)) {
            ...
            $ret = D('MemberOrganization')->insertMemberCabinet(array('member_id' => $this->_memberId, 'cabinet_id'=>$cabinetId));
