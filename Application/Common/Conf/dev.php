 ...
 */
return array(
    'WWW_ADDRESS' => 'http://asset.unibox.com.cn',
    'CDN_ADDRESS' => 'http://cdn.dev.unibox.com.cn/',
    'WWW_DOMAIN' => 'asset.unibox.com.cn',
    'DOWNLOAD_APP_ADDRESS' => '/app',

    'DB_TYPE'   => 'mysql', // 数据库类型
    'DB_HOST'   => 'rds8e2797ba67jjz969g.mysql.rds.aliyuncs.com', // 服务器地址
    ...
    'PUBLIC_PATH' => '/app/AssetApi/Public/',
    ...
    'memcache_config'  => array(
        'type'     =>'memcached',
        'servers'  =>array(array('127.0.0.1','7036')),
        'prefix'   =>'assetdev_',
        'expire'   =>600,
    ),
    ...
    'LOAD_EXT_CONFIG' => 'paypal_dev,authorize_dev',
    //国家代码
    COUTRYCODE=>'0086',
);
