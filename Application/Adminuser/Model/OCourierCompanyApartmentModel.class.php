...
class OCourierCompanyApartmentModel extends Model{

   // protected $trueTableName = 'o_courier_company_apartment';
    public function getCompanyCourier($courierId){
        return $this
            ->join('o_courier_company on o_courier_company.company_id = o_courier_company_apartment.company_id')
