...
class ZCourierApplyModel extends Model{

    public function getCourierApplyByMemberId($memberId){
        return $this->where(['member_id' => $memberId])->find();
    }

    public function insertCourierApply($data){
    ...
    public function getMemberList($wh){
        return $this->where($wh)->order('apply_id')->select();
    }
